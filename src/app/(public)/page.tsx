            ...
            <div className="z-10 w-full md:w-1/2 text-center md:text-left">
             ...
             <div className="w-full md:w-1/2 flex justify-center items-center p-4">
                <motion.div
                  ...
                  initial="initial"
                >
                    <svg viewBox="0 0 550 400" className="w-full h-auto drop-shadow-2xl" xmlns="http://www.w3.org/2000/svg" data-ai-hint="renault kangoo back">
                        <defs>
                        ...
                        <g className="origin-center" style={{ transformOrigin: "center" }}>
                            ...
                            <g className="origin-left transition-transform duration-1000 ease-in-out group-hover:[transform:rotateY(-140deg)]">
                                ...
                                {/* <!-- Logo da Empresa --> */}
                                <image href="/logvida-logo.png" x="115" y="150" height="48" width="120" className="transition-opacity duration-300 group-hover:opacity-0" />
                            </g>
                            {/* <!-- Porta Direita --> */}
