...
export function ClientCalendarView() {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    // Corrected query: Fetch all orders for the client and filter by date locally.
    // This is more efficient and avoids complex index requirements.
    ...
    const unsubscribe = onSnapshot(ordersQuery, (snapshot) => {
      const fetchedOrders = snapshot.docs
        .map(doc => sanitizeOrderFromFirestore(doc as DocumentSnapshot, "ClientCalendarView"))
